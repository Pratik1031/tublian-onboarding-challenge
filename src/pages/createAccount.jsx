    ...
    <div className='container'>
      <div className='display'>
        <div className='width50 banner-create-account'>
          ...
          <div
            className='display flexRow justContCenter alignCenter'
            style={{ height: '80vh' }}
          >
        ...
        <div className='width50' style={{ padding: '2rem' }}>
          ...
          <div className='display flexCol width55 margTop40'>
              ...
              {loginCriteria.map((lc, index) => {
                return (
                  <div
                    ...
                    className='display flexRow alignCenter marginBottom12'
                    key={index}
                  >
            ...
            <button
              className='login-button marginLeft12'
              onClick={() => {
                navigate('./setup');
              }}
            >
            ...
            <div className='flexRow display marginLeft28'>
              ...
              <span className='marginTop23'>Or</span>
              <div className='marginLeft12 line'></div>
            </div>

            <button className='google-sign flexRow display justContCenter alignCenter marginLeft12'>
              <span>
                {' '}
          ...
          <div className='display flexRow marginLeft12'>
            ...
            <a href='#' className='marginTop23 marginLeft12 highlight'>
              Login
            </a>
          </div>
          <Footer />
